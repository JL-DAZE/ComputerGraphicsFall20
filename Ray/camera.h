...
namespace Ray
{
	...
	public:
		...
		/** This function returns the group of 4 rays that leaves the camera and goes through pixel (i,j) of the view plane under jittered 4* anti-aliasing. */
		void getRay_AA(int i, int j, int width, int height, std::vector<Util::Ray3D>& result) const;
	};
